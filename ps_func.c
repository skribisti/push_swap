...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/12/11 11:53:43 by norabino          #+#    #+#             */
/*   Updated: 2024/12/11 11:53:45 by norabino         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	//Intervertit les 2 premiers éléments au sommet de la pile a ou b. 
	//Ne fait rien s’il n’y en a qu’un ou aucun
}

void	p_push(t_stack *src, t_stack *dst)
{
	//Prend le premier élément au sommet de src et le met sur dst.
